...
/**
 * "Rutinitas & Kebiasaan" — the former Routines page with its two sub-tabs
 * (Hari Ini + Kebiasaan & Konsistensi) merged into one scrollable view, so a
 * parent sees the daily checklist and the habit tracker together.
 */
